    ...
    <Navbar expand="lg" bg="lightblue" variant="dark" style={mystyle}>
      ...
      <Navbar.Collapse id="responsive-navbar-nav">
        <Nav className="ml-auto">
              ...
              <NavDropdown title="Vytvoření" id="basic-nav-dropdown">
                <NavDropdown.Item>
                  <Link href="/vytvareni-lektora">
                    <div className={classes.Dropitem}>Lektora</div>
                  </Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href="/vytvareni-predmetu">
                    <div className={classes.Dropitem}>Předmětu</div>
                  </Link>
                </NavDropdown.Item>
              </NavDropdown>
            </div>
              ...
              <NavDropdown title="Hodiny" id="basic-nav-dropdown">
                <NavDropdown.Item>
                  <Link href="/vytvoreni-hodiny">
                    <div className={classes.Dropitem}> Vytvoření hodiny</div>
                  </Link>
                </NavDropdown.Item>
                <NavDropdown.Item>
                  <Link href="hodiny">
                    <div className={classes.Dropitem}>Moje hodiny</div>
                  </Link>
                </NavDropdown.Item>
              </NavDropdown>
            </div>
          ...
          {session && (
            <Nav.Link>
              <Buttonlink link="kalendar-rezervaci" nazev="Rezervace">
                {" "}
              </Buttonlink>{" "}
            </Nav.Link>
          )}
          ...
          <Nav.Link>
            <Buttonlink link="/seznam-lektoru" nazev="O nás">
              {" "}
            </Buttonlink>
          </Nav.Link>
          ...
          {session && (
            <a onClick={logoutHandler}>
              <Nav.Link>
                <Buttonlink link="/" nazev="Odhlášení">
                  {" "}
                </Buttonlink>
              </Nav.Link>{" "}
            </a>
